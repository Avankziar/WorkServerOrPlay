...
public class WSOPCommandExecutor implements CommandExecutor
{
	private WSOP plugin;
	private static CommandConstructor cc;
	
	public WSOPCommandExecutor(WSOP plugin, CommandConstructor cc)
	{
		this.plugin = plugin;
		WSOPCommandExecutor.cc = cc;
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String lable, String[] args) 
	{
		...
		sender.spigot().sendMessage(ChatApiS.tl(ChatApiS.click(plugin.getYamlHandler().getLang().getString("InputIsWrong"),
	...
	public void baseCommands(final Player player, int page)
	{
		...
		String s = pastNextPage(player, page, control, plugin.getHelpList().size(), CommandSuggest.getCmdString(CommandSuggest.Type.WSOP));
		if(s != null)
		{
			msg.add(s);
		}
