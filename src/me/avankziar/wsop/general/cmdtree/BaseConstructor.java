...
import me.avankziar.wsop.general.database.YamlHandling;
...
public class BaseConstructor
{
	...
	private static LinkedHashMap<String, me.avankziar.wsop.spigot.cmdtree.ArgumentModule> argumentMapSpigot = new LinkedHashMap<>();
	private static LinkedHashMap<String, me.avankziar.wsop.bungee.cmdtree.ArgumentModule> argumentMapBungee = new LinkedHashMap<>();
	private static LinkedHashMap<String, me.avankziar.wsop.velocity.cmdtree.ArgumentModule> argumentMapVelo = new LinkedHashMap<>();
	...
	public static LinkedHashMap<String, me.avankziar.wsop.spigot.cmdtree.ArgumentModule> getArgumentMapSpigot()
	{
		return argumentMapSpigot;
	}
	
	public static LinkedHashMap<String, me.avankziar.wsop.bungee.cmdtree.ArgumentModule> getArgumentMapBungee()
	{
		return argumentMapBungee;
	}
	
	public static LinkedHashMap<String, me.avankziar.wsop.velocity.cmdtree.ArgumentModule> getArgumentMapVelo()
	{
